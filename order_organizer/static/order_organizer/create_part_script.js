(function (global) {
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        function send_post_request_form_data(form) {
            ...
            $ajaxUtils.sendPostRequest(formData, '/novo_artigo/' , handle_response_redirect, true);
        }
        ...
        function set_event_submit_new_part() {
            document.querySelector('#botao-criar-novo-artigo').addEventListener('click', gather_form_info_create_part)
        }
